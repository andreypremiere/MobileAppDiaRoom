            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Очень длинное название которое точно никогда не влезет в этот контейнер почтому что я написал тут слишком много ненужных слов, которые уже выдали ошибку',
                      maxLines: 2,
